...
http.createServer(function (req, res) {
    ...
    res.write("<h1>node js 의 http 모듈 안녕!</h1>");
        ...
        res.write(`<p>
                        <a href="power.do?a=3&b=6">파라미터 a,b 를 넘기면 두 값을 거듭제곱한 결과물을 반환하는 동적페이지</a>
                   </p>`);
    res.end();
        ...
        res.write(`<h1>${paramObj.a} 거듭 제곱 ${paramObj.b}의 결과는 :${Math.pow(paramObj.a,paramObj.b)}</h1>`)
        res.end();
    }
